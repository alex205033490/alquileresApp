       ...
       /* public bool pasarEventoalRIN(int codCoti)
        ...
        internal DataSet get_repuestoaCambiarDelEdificio(string edificio)
        {
            string consulta = "select "+
                                ...
                                " ,dc.codcoti "+ 
                                " ,dc.codrepuesto "+
                                " ,coti.codevento as 'ticket' "+ 
                                " from "+
                                " tb_detalle_cotirepuesto dc, "+
                                " tb_preciorepuesto pr, "+
                                " tb_cotizacionrepuesto coti, "+
                                " tb_evento even "+ 
                                " where "+
                                " dc.codcoti = coti.codigo and "+ 
                                ...
                                " coti.codevento = even.codigo and "+ 
                                " coti.codr144_padre is not null and "+
                                " dc.fechaentregaera is not null and "+
                                " dc.nroserial is not null and "+
                                " even.estadoEvento = 'Abierto' and "+
                                " coti.edificio = '"+edificio+"' and "+
                                " (dc.devolucionajyc is null or dc.devolucionajyc = false) and "+
                                " (dc.devolucionalcliente is null or dc.devolucionalcliente = false)"
                                ;
            return ConecRes.consultaMySql(consulta);                                
        }
        ...
        {
            string consulta0 = "update tb_detalle_cotirepuesto set "+
                               " tb_detalle_cotirepuesto.devolucionalcliente = "+devolucionalcliente+", "+
                               " tb_detalle_cotirepuesto.devolucionajyc = "+devolucionajyc+ 
                               " where "+
                               " tb_detalle_cotirepuesto.codcoti = "+codCoti+" and "+
                               " tb_detalle_cotirepuesto.codrepuesto = "+codrepuesto;
            bool bandera = ConecRes.ejecutarMySql(consulta0);
            ...
            string consulta = "insert into tb_boletadevolucionderepuestoalcliente( "+
                            ...
                            " '"+cantrepuesto+"', "+
                             ...
                             devolucionajyc+", "+
                            " '"+denominacionrepuesto+"', "+
                            " '"+observaciondevolucion+"', 'Mantenimiento')"; 
            return ConecRes.ejecutarMySql(consulta);          
        }
                                                       ...
                                                       bool devolucionajyc, string denominacionrepuesto, string observaciondevolucion)
        {
            ...
            string consulta = "insert into tb_boletadevolucionderepuestoalcliente( " +
                            ...
                            " '" + cantrepuesto + "', " +
                             ...
                             devolucionajyc + ", " +
                            " '" + denominacionrepuesto + "', " +
                            " '" + observaciondevolucion + "', 'Emergencia')";
            return ConecRes.ejecutarMySql(consulta);
        }
    }
}