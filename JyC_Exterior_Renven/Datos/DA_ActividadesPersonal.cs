...
namespace jycboliviaASP.net.Datos
{
    public class DA_ActividadesPersonal
    {
        ...
        {
            string consultaaux = "update tb_detalle_activiadpersonal " +
                                   " set " +
                                   " tb_detalle_activiadpersonal.detalle = '" + detalleCierre + "'" +                                   
                                   " where  " +
                                   " tb_detalle_activiadpersonal.codres = " + codUserCierre + "  and " +
                                   " tb_detalle_activiadpersonal.codact = " + codactividad;
            bool bandera = ConecRes.ejecutarMySql(consultaaux);
            ...
            string consulta = "update tb_ActividadPersonal " +
                               ...
                               " tb_ActividadPersonal.costopasaje = '" + costoPasaje.ToString().Replace(",", ".") + "'" +
                               " where tb_ActividadPersonal.codigo =" + codactividad;
            bool bandera2 = ConecRes.ejecutarMySql(consulta);
            if (bandera == bandera2 == true)
            {
                return true;
            }
            else
