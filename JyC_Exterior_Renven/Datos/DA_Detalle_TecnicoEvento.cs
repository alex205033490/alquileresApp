...
namespace jycboliviaASP.net.Datos
{
    public class DA_Detalle_TecnicoEvento
    {
        ...
        {   
                string consulta = "insert into tb_detalle_teceven(codeven,codtec,fecha_asignacion,hora_asignacion,supervisor) values (" + codEvento + "," + codTecnico + ",'" + fechaAsignacion + "','" + horaAsignacion + "',"+supervisor+")";
