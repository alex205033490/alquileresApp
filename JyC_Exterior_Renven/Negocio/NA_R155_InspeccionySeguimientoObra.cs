...
namespace JyC_Exterior.Negocio
{
    public class NA_R155_InspeccionySeguimientoObra
    {
        ...
        internal int getUltimaCodigoInsertado()
        {
            DataSet tupla= dr155.getUltimaCodigoInsertado();
          ...
          public DataSet getUltimoInsertado() {
              return dr155.getUltimoInsertado();
          }

        internal DataSet getUltimoReporteIngresado(int codedificio, int codresponsable)
        {
            return dr155.getUltimoReporteIngresado(codedificio, codresponsable);
        }
    }
}