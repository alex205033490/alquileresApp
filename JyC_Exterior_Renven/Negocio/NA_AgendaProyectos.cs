...
namespace jycboliviaASP.net.Negocio
{
    public class NA_AgendaProyecto
    {
        ...
        {
            return nagenda.getAgendaporCodigoResponsable(codigoResponsableAsignado);
        }

        public DataSet getAgendaporCodigoAgendaProyecto(int codigoAgenda)
        {
            return nagenda.getAgendaporCodigoAgendaProyecto(codigoAgenda);        
        }


        internal bool cerrarAgendaProyecto(int codAgendaProyecto, string detalleCierre, int codUser, float costotransporte)
        {
            return nagenda.cerrarAgendaProyecto(codAgendaProyecto, detalleCierre, codUser,  costotransporte);
        }
    }
}