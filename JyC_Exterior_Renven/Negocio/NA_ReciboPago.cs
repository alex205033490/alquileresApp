...
namespace jycboliviaASP.net.Negocio
{
    public class NA_ReciboPago
    {
        ...
        {
            return reciboPagoD.insertarReciboMTTO(codseg, codmes, detalle, pago, efectivo, deposito, nrocheque, banco, factura, recibo, codresp, codcobranza, tipoCambio, codmoneda, transferencia, fechaPago, costoTransporte);
        }


        internal bool dardeBajaelCobro(int codRuta, string detalleRecibo, int codUserCierre)
        {
            return reciboPagoD.darDeBajaelCobro( codRuta,  detalleRecibo,  codUserCierre);
        }
    }
}