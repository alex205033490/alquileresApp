...

{
    public class NA_Equipo
    {
        ...
        public DataSet getAllResponsableProyecto(string exbo, string edificio, string nameRespEdificio, string nameTecnicoInstalador, string NombreEstado, bool polizaSeguro, bool boletaBancaria, bool letraCambio, bool exportar)
        {
            string consulta = " select "+
                               " proy.polizaseguro,  "+
                               " proy.boletabancaria,  "+
      ...
      internal DataSet get_ciudadInstalacion(int codigoEquipo)
      {
          return Dequipo.get_ciudadInstalacion( codigoEquipo);
      }
    }
}