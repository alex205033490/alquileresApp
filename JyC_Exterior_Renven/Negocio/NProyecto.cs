...
namespace jycboliviaASP.net.Negocio
{
    public class NProyecto
    {
        ...
        public bool modificarEncargadoProyPP(int codigo, string nombre, string direccion, int codigoEncargado, int codigoResponsable, int estado, int codzona, string departamento, string nit, string facturar, string banco, int codcobradorasignado)
        {
            return proyecto.modificarProyectoEncargadoPagoPP(codigo, nombre, direccion, codigoEncargado, codigoResponsable, estado, codzona, departamento, nit, facturar, banco, codcobradorasignado);
        }
        ...
        public bool registrar1(string nombre, string nombre2, string fecha_Proy, int codigoEncargado, int estado, string ciudad, int codPropietario)
        {
            return proyecto.insertarProyecto1(nombre, nombre2, fecha_Proy, codigoEncargado, estado, ciudad, codPropietario);
        }

        public bool modificarProyecto1(int codProyecto, string nombre, string fecha_Proy, int estado, string ciudad)
        {
            return proyecto.modificarProyecto1(codProyecto, nombre, fecha_Proy, estado, ciudad);
        }
        ...
        {
            return proyecto.getencargadoObraProyecto( codigoEdificio);
        }

        internal bool actulizarEncargadoObraProyecto(int codigoEdificio, string nombreEncargadoObra, string celularEncargadoObra, string correoEncargadoObra)
        {
            DataSet tuplaEncargadoObraProy = getencargadoObraProyecto(codigoEdificio);
            bool bandera = false;
            if (tuplaEncargadoObraProy.Tables[0].Rows.Count > 0)
            {
                int codEncargado = Convert.ToInt32(tuplaEncargadoObraProy.Tables[0].Rows[0][0].ToString());
                bandera = proyecto.actulizarEncargadoObraProyecto(codEncargado, nombreEncargadoObra, celularEncargadoObra, correoEncargadoObra);
            }
            else
            {
                bandera = proyecto.insertarEncargadoObraProyecto(codigoEdificio ,nombreEncargadoObra, celularEncargadoObra, correoEncargadoObra, "Ingresado por JyCExterior");
        ...
        internal string get_rcc(string nombreProyecto)
        {
            DataSet dato = proyecto.get_rcc( nombreProyecto);
            if (dato.Tables[0].Rows.Count > 0)
            {
        ...
        internal string get_fiscal(string nombreProyecto)
        {
            DataSet dato = proyecto.get_fiscal(nombreProyecto);
            if (dato.Tables[0].Rows.Count > 0)
            {
                return dato.Tables[0].Rows[0][1].ToString();
            }
        ...
        internal int get_cantidadEquipos(string nombreProyecto)
        {
            throw new NotImplementedException();
        }
    }
