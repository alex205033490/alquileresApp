...
namespace jycboliviaASP.net.Negocio
{
    public class NA_Repuesto
    {
        ...
        public DataSet getCotizacionesRepuestoRCC(string codigoCoti, string edificio, string cite, string estado, bool vendido, bool rechazado, bool areacliente)
        {
          /*  string consulta = "select cr.codigo as 'Codigo Coti', "+
                               " date_format(cr.fecha,'%d/%m/%Y') as 'fecha' , "+
                               " cr.hora,"+
                               ...
                               " from tb_cotizacionrepuesto cr "+
                               " LEFT JOIN tb_detalle_callcenter_cotirepuesto dc ON (cr.codigo = dc.codcotirepuesto) "+                               
                               " where  "+                               
                               " not(cr.cite = '') and "+
                               " cr.estadocoti = '"+estado+"' "+
                               " and cr.codigo not in "+
                               " ( "+
                               " select  "+
                               " co.codigo  "+
                               " from "+
                               " tb_evento even, tb_detalle_callcenter_cotirepuesto cc, tb_cotizacionrepuesto co "+
                               " where "+
                               " even.codigo = cc.codcallcenter and "+
                               " cc.codcotirepuesto = co.codigo and "+
            ...
            string consulta = "select cr.codigo as 'Codigo Coti', "+
                               ...
                               " co.codigo "+ 
                               " from "+
                               " tb_evento even, tb_cotizacionrepuesto co "+
                               " where "+
                               ...
                               " even.arearcc = 1)";
                                ...
                                consulta = consulta + " order by timestamp(cr.fecha, cr.hora) desc  limit 200 ";                   
    ...
    /*   public bool estaEntregadoelRepuestoJyC(int codCotizacionRepuesto, int codRepuesto)
        ...
        */
        ...
        public static bool IsNumeric(string Expression)
         ...
         internal DataSet get_repuestoaCambiarDelEdificio(string edificio)
         {
             return Drepuesto.get_repuestoaCambiarDelEdificio(edificio);
         }

         internal bool devoluciondeRepuestosporTecnico(int codCoti, int codboletavisitaruta, int codedificio, string edificio, string cliente,
                                                       int codrealizadopor, string realizadopor, string recepcionadopor, string recepcionadoporci,
                                                       int codrepuesto, string repuestoname, float cantrepuesto, bool devolucionalcliente,
                                                       bool devolucionajyc, string denominacionrepuesto, string observaciondevolucion)
         {
             return Drepuesto.devoluciondeRepuestosporTecnico(codCoti,codboletavisitaruta,  codedificio,  edificio,  cliente,
                                                        codrealizadopor,  realizadopor,  recepcionadopor,  recepcionadoporci,
                                                        codrepuesto,  repuestoname,  cantrepuesto,  devolucionalcliente,
                                                        devolucionajyc, denominacionrepuesto,  observaciondevolucion);
         }

         internal bool devoluciondeRepuestosporTecnico_callcenter(int codCoti, int codboletaemergenciacallcenter, int codedificio, string edificio, string cliente,
                                                        int codrealizadopor, string realizadopor, string recepcionadopor, string recepcionadoporci,
                                                        int codrepuesto, string repuestoname, float cantrepuesto, bool devolucionalcliente,
                                                        bool devolucionajyc, string denominacionrepuesto, string observaciondevolucion)
         {
             return Drepuesto.devoluciondeRepuestosporTecnico_callcenter(codCoti, codboletaemergenciacallcenter, codedificio, edificio, cliente,
                                                           codrealizadopor, realizadopor, recepcionadopor, recepcionadoporci,
                                                           codrepuesto, repuestoname, cantrepuesto, devolucionalcliente,
                                                           devolucionajyc, denominacionrepuesto, observaciondevolucion);
         }
